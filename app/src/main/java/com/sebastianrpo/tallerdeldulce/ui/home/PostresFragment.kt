...
class PostresFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val postresViewModel =
            ViewModelProvider(this)[PostresViewModel::class.java]

        _binding = FragmentPostresBinding.inflate(inflater, container, false)
        val root: View = binding.root

        val textView: TextView = binding.textPostres
        postresViewModel.text.observe(viewLifecycleOwner) {
            textView.text = it
        }
        return root
    }
